...
qx.Class.define("qx.event.type.Native",
{
  ...
  members :
  {
    ...
    // @ITG:Wisej: Overridden stop() to make it work for native event wrappers as well.
    /**
    ...
    // @ITG:Wisej: Added implementation for stopPropagation() for native events.
    /**
    ...
    stopPropagation: function () {
      this.base(arguments);
      qx.bom.Event.stopPropagation(this._native);
    },
