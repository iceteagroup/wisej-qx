  ...
  */
  ...
  members :
  {
    ...
    */
    ...
    /**
     * Applies the appearance property in a safe block in order to 
     * prevent the loop from breaking down in case of an unknown property in the theme.
     *
     * @param widget {qx.ui.core.Widget} The target widget.
     * @param unstyler {Map} Map of property resetters.
     * @param styler {Map} Map of property setters.
     * @param name {String} The naem of the property to assign..
    ...
    /**
     * Clears the appearance property in a safe block in order to 
     * prevent the loop from breaking down in case of an unknown property in the theme.
     *
     * @param widget {qx.ui.core.Widget} The target widget.
     * @param unstyler {Map} Map of property resetters.
     */
    clearProperty: function (widget, unstyler, name) {

        try {
            widget[unstyler[name]]();
        }
        catch (e) {
           qx.log.Logger.error(widget, "Error clearing the property '" + widget.name + "." + name + "'.", e);
        }
    },
