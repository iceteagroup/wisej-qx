  ...
  members :
  {
    ...
    _syncData : function()
    {
      ...
      if (jobs)
      {
        ...
        if (data) {
          ...
          this._translateRtlStyles(styles);
    ...
    */
    ...
    moveTo : function(index)
    {
      ...
      // @ITG:Wisej: Replaced with faster call to qx.lang.Array.move().
    ...
    */
    ...
    setTextSelection : function(start, end)
    {
      var el = this.__element;
      // if (el) {
      // @ITG:Wisej: Cannot set the selection range directly to an element that is not visible yet. In IE and Edge attempting
    ...
    */
    ...
    // @ITG:Wisej: RightToLeft support.
    /**
     * Translates the styles before being
     * applied to the element in order to
     * apply the right-to-left mode, if set.
     *
     * @param styles {Map} a map where the key is the name of the property
     *    and the value is the value to use.
     */
    _translateRtlStyles: function(styles) {
      // it seems like it's only "textAlign" that needs to be flipped.
      var textAlign = styles["textAlign"];
      if (textAlign) {
        var rtl = this._getProperty("rtl");
        if (rtl) {
    ...
    */
    ...
    /**
     * Checks if the element uses a css class.
     * @param name {String} Name of the CSS class.
     */
    hasClass: function (name) {
    	var currentClass = this.getAttribute("class") || "";
    	return (" " + currentClass + " ").indexOf(" " + name + " ") > -1;
    },
    ...
    addClass : function(name) {
      ...
      // @ITG:Wisej: Added code to check if the class has already been added.
    ...
    removeClass : function(name) {
      var currentClass = this.getAttribute("class");
      if (currentClass) {
        // @ITG:Wisej: Avoid removing the wrong class when the name is part of the name of another css class.
