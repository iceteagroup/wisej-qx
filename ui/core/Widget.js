...
qx.Class.define("qx.ui.core.Widget",
{
  ...
  */
  ...
  events :
  {
	...
	// @ITG:Wisej: Added support for dragenter compatible with html5 drag-drop.
  	/**
     ...
     * http://www.whatwg.org/specs/web-apps/current-work/#dnd
     */
    dragenter: "qx.event.type.Drag",

    /**
     * Fired on a potential drop target when the pointer moves over it during a drag-drop operation.
     * This event can be canceled if none of the incoming data types
     * are supported.
     *
     * Modeled after the WHATWG specification of Drag&Drop:
  ...
  properties :
  {
    ...
    */
    ...
    paddingTop :
    {
      ...
      apply : "_applyPadding",
      themeable: true,
      // @ITG:Wisej:Added "changePadding" event.
      event: "changePadding"
    },
    ...
    */
    ...
    /**
     * The rtl property informs a widget that it should
     * render itself using the right-to-left mode.
     *
     * When rtl is true, the widget gets the "rightToLeft" state.
     */
    rtl :
    {
      init: false,
    ...
    */
     ...
     *
     * Please note: -1 disables tabbing into the widget.
	 * See: https://www.w3.org/TR/2011/WD-html5-20110525/editing.html#sequential-focus-navigation-and-the-tabindex-attribute
     */
    tabIndex :
    {
      check : "Integer",
  ...
  members :
  {
    ...
    */
    ...
    renderLayout : function(left, top, width, height)
    {
      ...
      // @ITG:Wisej: RightToLeftLayout support.

      // update the location of all the children if this widget is $$mirrored.
      if (this.$$mirrored) {
        this._mirrorChildren(true);
      }
      ...
      // @ITG:Wisej: End of RightToLeftLayout support.
    ...
    */
    ...
    getInsets : function()
    {
      ...
      if (this.getDecorator()) {
        ...
        // @ITG:Wisej: Under certain circumstances the decorator may be null since the theme may not be fully loaded.
        if (decorator) {
    ...
    */
    ...
    _applyTextColor: function (value, old) {
      ...
      // @ITG:Wisej: Added default implementation to set the color for the widget to let it inherit by child elements.
      ...
      if (content) {
        var resolved = qx.theme.manager.Color.getInstance().resolve(value);
        content.setStyle("color", resolved);
      }
    ...
    _applyRtl: function (value, old) {
      ...
      this.getContentElement()._setProperty("rtl", value);
    },

    /**
     * Mirrors the horizontal location of the direct children.
     *
     * @param mirror {Boolean} When true the horizontal location the direct children is mirrored.
     */
    _mirrorChildren: function (mirror) {
      ...
      // update the layout of the direct children.
      this.invalidateLayoutCache();
      this.invalidateLayoutChildren();
      var children = this._getChildren();
      for (var i = 0, l = children.length; i < l; i++) {
        children[i].__computedLayout = null;
    ...
    _applyBackgroundColor : function(value, old) {
      ...
      if (value == null) {
        if (content) {
          content.setStyle("backgroundColor", null);
    ...
    syncAppearance : function()
    {
      ...
      if (newData)
      {
        if (oldData)
        {
          for (var prop in oldData)
          {
            if (newData[prop] === undefined) {
              ...
              // @ITG:Wisej: Delegate theme property assignment to the Appearance manager to better handle missing properties.
              // this[unstyler[prop]]();
              manager.clearProperty(this, unstyler, prop);
            }
          }
        }
        ...
        for (var prop in newData) {
          ...
          manager.setProperty(this, unstyler, styler, prop, newData[prop]);
        }
      }
      else if (oldData)
      {
    ...
    */
    ...
    isTabable : function () {
      ...
      // @ITG:Wisej: Fixed check for visibility: having a DOM element is not enough, hidden widgets have a DOM element too.
      var dom = this.getContentElement().getDomElement();
      if (!!dom && dom.offsetWidth == 0)
        return false;

      // @ITG:Wisej: Fixed tabIndex range according to the HTML5 specs: https://www.w3.org/TR/2011/WD-html5-20110525/editing.html#sequential-focus-navigation-and-the-tabindex-attribute
      return this.getTabIndex() > -1 && !!dom && this.isFocusable();
    },
    ...
    _applyFocusable : function(value, old)
    {
      ...
      {
		// @ITG:Wisej: Setting the tabIndex to -1 removes the element from navigation but it's still focusable.
    ...
    */
    ...
    getContentLocation : function(mode)
    {
      ...
      var domEl = el != null ? el.getDomElement() : null;
