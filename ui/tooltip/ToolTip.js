...
qx.Class.define("qx.ui.tooltip.ToolTip",
{
  ...
  */
  ...
  members :
  {
    ...
    {
      placementLeft: true,
      // @ITG:Wisej: Added placement states.
      placementRight: true,
      placementAbove: true,
      placementBelow: true,
    },
    ...
    */
    ...
    {
      // @ITG:Wisej: Added icon placement above and below.
      var wasHoriz = (old == "left" || old == "right");
      var isHoriz = (value == "left" || value == "right");
      if (wasHoriz != isHoriz)
      {
        this._getLayout().dispose();
        this._setLayout(isHoriz ? new qx.ui.layout.HBox() : new qx.ui.layout.VBox());
      }
