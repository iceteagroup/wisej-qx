  ...
  */
  ...
  members :
  {
    ...
    */
    ...
    // @ITG:Wisej: When the window is maximize it shouldn't enforce the max width/height.
    getSizeHint: function (compute) {

      // get the original size hint
      var hint = this.base(arguments, compute);

      if (hint != null && this.hasState("maximized")) {
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch(id)
      {
        ...
        case "title":
          ...
          // @ITG:Wisej: We want the title to be considered when calculating the size hint.
          // control.setWidth(0);
    ...
    */
    ...
    minimize : function()
    {
      ...
      if (this.fireNonBubblingEvent("beforeMinimize", qx.event.type.Event, [false, true]))
      {
        // store current dimension and location
        var props = this.getLayoutProperties();
        // @ITG:Wisej: Don't override the location when minimizing a maximized window.
        //this.__restoredLeft = props.left === undefined ? 0 : props.left;
        //this.__restoredTop = props.top === undefined ? 0 : props.top;
        this.__restoredLeft = props.left === undefined ? this.__restoredLeft : props.left;
        this.__restoredTop = props.top === undefined ? this.__restoredTop : props.top;
    ...
    */
    ...
    _onRtlChange: function (e) {
      ...
      var rtl = e.getData();
      if (rtl != null) {
        this.getChildControl("captionbar")._mirrorChildren(rtl);
      }
    },
