  ...
  members :
  {
    ...
    */
    ...
    _applyEditable: function (value, old)
    {
      ...
      // @ITG:Wisej:Bug fix, setReadonly turns focusable on the textfield causing the spinner to lose the focusable state.
    ...
    _updateButtons : function() {
      ...
      else
      {
        if (this.getWrap())
        {
          // If wrapped -> always enable buttons
    ...
    */
    ...
    _onKeyUp: function(e)
    {
      switch(e.getKeyIdentifier())
      {
        ...
        // @ITG:Wisej: Stop the keyup event from bubbling otherwise this control cannot be used as a cell editor.
      e.stopPropagation();
      e.preventDefault();
