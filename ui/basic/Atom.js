...
qx.Class.define("qx.ui.basic.Atom",
{
  ...
  */
  ...
  members :
  {
    ...
    {
      // @ITG:Wisej: Hide the label on an empty string as well - it shows nothing anyway.
      // if (this.getLabel() == null || this.getShow() === "icon") {
      if (!this.getLabel() || this.getShow() === "icon") {
    ...
    {
	  // @ITG:Wisej: Hide the icon on an empty string as well - it cannot be a valid icon.
      // if (this.getIcon() == null || this.getShow() === "label") {
      if (!this.getIcon() || this.getShow() === "label") {
