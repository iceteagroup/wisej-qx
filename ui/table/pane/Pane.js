  ...
  members :
  {
    ...
    _updateAllRows : function()
    {
      ...
      if (!elem) {
        ...
        // @ITG:Wisej: Need to remove the listener first, otherwise this may end up recreating the entire grid several times.
        this.removeListener("appear", arguments.callee, this);
      ...
      else
      {
       ...
       // @ITG:Wisej: Remove the child node before assigning innerHTML, in IE10,11
       // it invalidates any widget and roots using a cell's element to render inside a cell.
      if (elem.firstChild)
