  ...
  */
  ...
  members :
  {
    ...
    _onChangeTheme : function() {
     ...
     // @ITG:Wisej: Need to sync the appearance before updating the content,  otherwise we get the init (unthemed) values. i.e. rowHeight doesn't use the theme.
      this.syncAppearance();
    ...
    isEditing : function()
    {
      ...
      {
        // @ITG:Wisej: May have zero columns.
