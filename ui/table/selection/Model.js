  ...
  members :
  {
    ...
    setSelectionInterval : function(fromIndex, toIndex)
    {
      ...
      switch(this.getSelectionMode())
      {
        ...
        // @ITG:Wisej: Added check for actual selection change, otherwise
        // this class fires the "changeSelection" event on every click.
        case me.MULTIPLE_INTERVAL_SELECTION:

          var range = this.__selectedRangeArr;
          if (range && range.length == 1 && range[0].minIndex == fromIndex && range[0].maxIndex == toIndex) {
              return;
          }
          break;
