...
qx.Class.define("qx.ui.tree.core.AbstractTreeItem",
{
  ...
  members :
  {
    ...
    */
    ...
    {
      // @ITG:Wisej: Fixed error during shutdown when __children is null.
      if (!this.__children)
        return;
      ...
      for (var i=0, l=arguments.length; i<l; i++)
      {
        ...
        treeItem.setParent(null);
      	...
      	// @ITG:Wisej: Check if the container still contains the item, the destructor may have removed it.
	    if (container.indexOf(treeItem) > -1)
