...
qx.Class.define("qx.ui.virtual.layer.WidgetCellSpan",
{
  ...
  */
  ...
  destruct : function()
  {
    ...
    // @ITG:Wisej: There may be items in the __spacerPool that are not children. Need to dispose those too.
    for (var i = 0; i < this.__spacerPool.length; i++) {
      this.__spacerPool[i].dispose();
    }
