...
/**
 * A TabButton is the tabable part sitting on the {@link qx.ui.tabview.Page}.
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch(id) {
        case "label":
          ...
          // @ITG:Wisej: TabButton shows empty labels when initially created even if set to null.
          if (this.getLabel() == null || this.getShow() === "icon") {
            control.exclude();
          }

          // @ITG:Wisej: Doesn't apply the rich property.
        ...
        case "icon":
          ...
          // @ITG:Wisej: TabButton shows empty icons when initially created even if set to null.
