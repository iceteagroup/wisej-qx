...
qx.Mixin.define("qx.ui.decoration.MBorderRadius",
{
  ...
  members :
  {
    ...
    {
      // @ITG:Wisej: This fix is not necessary anymore and we added
      // support for the background-clip style in the MSingleBorder decorator.
      ...
      // @ITG:Wisej: Removed the repeated fix.
      // Fixing the background bleed in Webkits
      // http://tumble.sneak.co.nz/post/928998513/fixing-the-background-bleed
