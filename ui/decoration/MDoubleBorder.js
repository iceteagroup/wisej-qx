  ...
  */
  ...
  properties :
  {
    ...
    */
    ...
    // @ITG:Wisej: Added the style property to the inner border.
    ...
    */
    ...
    /** top inner style of border */
    innerStyleTop:
    {
      nullable: true,
      init: "solid",
      check: ["none", "solid", "dotted", "dashed", "double", "inset", "outset", "ridge", "groove"],
      apply: "_applyDoubleBorder"
    },

    /** right inner style of border */
    innerStyleRight:
    {
      nullable: true,
      init: "solid",
    ...
    /**
     * Property group for the inner style properties.
     */
    innerStyle:
    {
      group: ["innerStyleTop", "innerStyleRight", "innerStyleBottom", "innerStyleLeft"],
      mode: "shorthand"
    },
  ...
  members :
  {
    ...
    __styleDoubleBorder : function(styles)
    {
      ...
      if (
        ...
        var borderTop = (innerWidth.top || 0) + "px " + this.getInnerStyleTop() + " " + innerColor.top;
        var borderRight = (innerWidth.right || 0) + "px " + this.getInnerStyleRight() + " " + innerColor.right;
        var borderBottom = (innerWidth.bottom || 0) + "px " + this.getInnerStyleBottom() + " " + innerColor.bottom;
        var borderLeft = (innerWidth.left || 0) + "px " + this.getInnerStyleLeft() + " " + innerColor.left;
        ...
        // @ITG:Wisej: The :before element is enough for the inner border.
