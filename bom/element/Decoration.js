  ...
  statics :
  {
    ...
    update : function(element, source, repeat, style)
    {
      ...
      if (tag === "img") {
        ...
        element.src = ret.src || qx.ui.basic.Image.PLACEHOLDER_IMAGE;
      }
    ...
    getAttributes : function(source, repeat, style)
    {
      ...
      // @ITG:Wisej: Normalize browsers rendering position of svg sources: chrome starts at 0,0 while IE centers.
      if (format == "svg")
    ...
    __processRepeats : function(style, repeat, sourceid)
    {
      ...
      {
        // @ITG:Wisej: Fixed padding preservation on background images by using background-origin instead of altering the position.
        // It's not supported in IE8 but those browsers should all be gone by now...
