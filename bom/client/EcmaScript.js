...
qx.Bootstrap.define("qx.bom.client.EcmaScript",
{
  statics :
  {
    ...
    /**
     * Checks if 'trimStar' is supported on the String object.
     * @internal
     * @return {Boolean} <code>true</code>, if the method is available.
     */
    getStringTrimStart : function() {
      return typeof String.prototype.trimStart === "function";
    },


    /**
     * Checks if 'trimEnd' is supported on the String object.
     * @internal
     * @return {Boolean} <code>true</code>, if the method is available.
     */
    getStringTrimEnd : function() {
  ...
  defer : function(statics) {
    ...
    qx.core.Environment.add("ecmascript.string.trimEnd", statics.getStringTrimEnd);
    qx.core.Environment.add("ecmascript.string.trimStart", statics.getStringTrimStart);
