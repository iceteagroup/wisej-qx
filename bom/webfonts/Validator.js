  ...
  members :
  {
    ...
    */
    ...
    __onTimerInterval : function()
    {
     ...
     // @ITG:Wisej: Need to be able to tell whether the FontManager is busy checking fonts.

    /**
     * Returns true if the validator is still checking the font.
     */
    isValidating: function () {

      return this.__checkTimer != null
        ? this.__checkTimer.isEnabled()
        : false;
    },
