...
qx.Bootstrap.define("qx.bom.Stylesheet",
{
  ...
  */
  ...
  statics :
  {
     ...
     * @param onload {Function?} Function to execute on success
     * @param onerror {Function?} Function to execute on error
     */
    includeFile : function(href, doc, onload, onerror)
    {
      if (!doc) {
        doc = document;
      }
    ...
    addRule : function(sheet, selector, entry)
    {
      ...
      // @ITG:Wisej: Suppress potential Syntax Error in the browser for the :placeholder pseudo.
      try {
        ...
        qx.log.Logger.error("Error adding the rule: " + selector + "{" + entry + "}: " + err);
      }
    },
