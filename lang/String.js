...
qx.Bootstrap.define("qx.lang.String",
{
  statics :
  {
    ...
    // @ITG:Wisej: Added toHashCode() mostly to generate smaller faster keys for the ImageLoader.
    /**
     * Generates an hash code for the given string.
     * This method uses the same algorithm in Java's String.hashCode().
     *
     * @param str {String} String for which to generate the hash code.
     * @return {Integer} An integer value representing the string.
     */
    toHashCode: function (str) {
      ...
      /* Alternative sdbm algorithm.
       * Commented in here for reference only.
       *
      for (var i = 0, length = str.length; i < length; i++) {
      	char = str.charCodeAt(i);
