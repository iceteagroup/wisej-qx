...
qx.Bootstrap.define("qx.lang.normalize.String", {
  ...
  statics : {
     ...
     *
     * <a href="https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/String/TrimStart">MDN documentation</a> |
     * <a href="http://es5.github.com/#x15.5.4.20">Annotated ES5 Spec</a>
     *
     * @return {String} The trimmed string
     */
     ...
     *
     * <a href="https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/String/TrimEnd">MDN documentation</a> |
     * <a href="http://es5.github.com/#x15.5.4.20">Annotated ES5 Spec</a>
     *
     * @return {String} The trimmed string
     */
  ...
  defer : function(statics)
  {
    ...
    // trimLeft
    if (!qx.core.Environment.get("ecmascript.string.trimStart")) {
      String.prototype.trimStart = String.prototype.trimLeft = statics.trimLeft;
    }
    // trimRight
    if (!qx.core.Environment.get("ecmascript.string.trimEnd")) {
      String.prototype.trimEnd = String.prototype.trimRight = statics.trimEnd;
    }
    // startsWith
