  ...
  */
  ...
  members :
  {
    ...
    format : function(date)
    {
      ...
      // @ITG:Wisej: Added support for Buddhist calendar year shift.
      fullYear += this.__getCalendarYearGap();
    ...
    parse : function(dateStr)
    {
      ...
      // @ITG:Wisej: Adjust for Buddhist (Thai) year gap.
      dateValues.year -= this.__getCalendarYearGap();
    ...
    // @ITG:Wisej: Added support for Buddhist calendar year shift.
    /**
     * Returns the difference between the calendar year and the date year.
     * It's zero in most cases. It's 543 for Thai - I don't know about
     * other calendars, but this function should work in all cases supported by the OS.
     */
    __getCalendarYearGap: function () {
