...
qx.Class.define("qx.util.placement.Placement",
{
  ...
  statics :
  {
     ...
     *   It is guaranteed the new position attaches the object to one of the
     *   target edges and that is aligned with a target edge.</li>
     ...
     *   the 'modeX' argument.
     * @param rtl {Boolean?} When true, inverts the horizontal position.
     * @return {Map} A map with the final location stored in the keys
     *   <code>left</code> and <code>top</code>.
     */
    compute: function(size, area, target, offsets, position, modeX, modeY, rtl)
    {
